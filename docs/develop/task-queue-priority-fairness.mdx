...
Fairness will be a paid feature in Temporal Cloud and billing will be enabled in the near future. All actions performed while Fairness is enabled will incur a 10% upcharge in that Namespace.
